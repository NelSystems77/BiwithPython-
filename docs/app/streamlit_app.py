...
Esta es la version que corre 100% en el navegador via stlite (WebAssembly),
publicada en GitHub Pages. Es el mismo codigo que app/dashboard.py en la
raiz del repositorio (la version que corres localmente con
`streamlit run app/dashboard.py`), adaptado unicamente para vivir dentro de
la carpeta docs/ que sirve el sitio.
"""
...
st.caption("Proyecto capstone del curso BI con Python: Zero to Hero — corriendo en tu navegador con stlite")
